 ...
 *
 * <p>
 * Thread-safety: This class is immutable with respect to its RestClient reference.
 * Ensure RestClient itself is thread-safe if this instance is shared across threads.
 * </p>
 */
public class AuthEndpoints extends BaseAPI {
    ...
    /**
     * Performs logout. Preserves original behavior of returning the raw Response.
     * Adds logging and error handling to make issues easier to diagnose.
     *
    ...
    /**
     * Performs logout and returns an Optional-wrapped Response for null-safety.
     *
     * @return Optional containing the Response, or empty if the response was null or an error occurred
     */
